cardArray = [
    {text: "A", image: "images/Level1/C-Saw-C.png"},
    {text: "A", image: "images/Level1/C-Saw-C@2x.png"},
    {text: "B", image: "images/Level1/GoGreen.png"},
    {text: "B", image: "images/Level1/GoGreen@2x.png"},
    {text: "C", image: "images/Level1/Bee.png"},
    {text: "C", image: "images/Level1/Bee@2x.png"},
    {text: "D", image: "images/Level1/Alien.png"},
    {text: "D", image: "images/Level1/Alien@2x.png"},
    {text: "E", image: "images/Level1/Girl.png"},
    {text: "E", image: "images/Level1/Girl@2x.png"},
    {text: "F", image: "images/Level1/FitFred.png"},
    {text: "F", image: "images/Level1/FitFred@2x.png"},
    {text: "G", image: "images/Level1/MrFace.png"},
    {text: "G", image: "images/Level1/MrFace@2x.png"},
    {text: "H", image: "images/Level1/Elfee-E.png"},
    {text: "H", image: "images/Level1/Elfee-E@2x.png"},
    {text: "I", image: "images/Level1/Dude.png"},
    {text: "I", image: "images/Level1/Dude@2x.png"}
];
